 ...
 * @endcode
 */
$settings['hash_salt'] = 'OKrzIvlCmVkOALGPQEyGqxmErxYhRPiQuiOi9NikWtMMlCxDd0llnH_q65k2681VAKs5eFbgyQ';
...
if (!empty(getenv('MYSQL_DATABASE')) || !empty($_SERVER['MYSQL_DATABASE'])) {
